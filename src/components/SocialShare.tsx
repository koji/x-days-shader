...
export const SocialShare: React.FC<SocialShareProps> = ({ shader, className = '' }) => {
  ...
  return (
    <div className={`flex flex-col space-y-4 ${className}`}>
      <h3 className="text-lg font-semibold text-white">Share this shader</h3>
      ...
      <div className="flex flex-wrap gap-3">
        {shareLinks.map((platform) => (
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 bg-gray-700 ${platform.color} text-white rounded-lg transition-all duration-200 hover:scale-105`}
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 bg-gray-800 rounded-lg px-3 py-2 text-sm text-gray-300 font-mono truncate">
          {shareUrl}
        </div>
      </div>
